        ...
        <div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
            ...
            <div id="topbar" class="top-bar"  style="width: 100%;height:52px; background: #0092dc url('${ctx}/static/images/mosaic-pattern.png') repeat;">
                 ...
                 <div class="top-bar-left">
                    <h1 style="margin-left: 10px; margin-top: 10px;color: #fff"> <img src="${ctx}/static/images/logo.png" >TreeSoft数据库管理系统<span style="color:#00824D;font-size:14px; font-weight:bold;">&nbsp;TreeNMS</span>  <span style="color: #fff;font-size:12px;">V1.7.3</span> </h1>
                </div>
